...
\address{Volcan Corcovado 5820, Dpto 207, Torre 2, Puerto Montt, Los Lagos, Chile}
\mobile{(+56) 962034487}
...
\position{Ingeniero Civil en Telecomunicaciones{\enskip\cdotp\enskip}Python Developer} % Your expertise/fields

\makecvfooter{\today}{Claudio A. Parra~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
