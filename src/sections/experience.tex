...
\end{itemize}
\techenv{Python, Fast API, Flask, Docker, Git, VS Code, Jenkins, Linux, GCP, Airflow}
...
\cvevent{Assistant Student: ICT Extension}{Universidad de Concepción}{March 2014 -- December 2015}{Concepción}{logos/udec-logo.png}
\begin{itemize}
...
\cvevent{Assistant Student}{Universidad de Concepción}{March 2014 -- December 2015}{Concepción}{logos/udec-logo.png}
\begin{itemize}
