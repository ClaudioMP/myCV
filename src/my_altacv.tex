...
% Add the tag for thech stacks:
% Claudio estuvo aqui
\newcommand{\techtag}[1]{
  \tikz[baseline]\node[anchor=base,draw=body!45,rounded corners,inner xsep=.5ex,inner ysep =0.5ex,text height=1.3ex,text depth=.25ex,color=headingrule]{#1};
}
\newcommand{\techenv}[1]{\foreach \n in {#1}{\techtag{\color{heading}\n}}}
\newcommand{\tagenv}[1]{\foreach \n in {#1}{\cvtag{\n}}}


\newcommand{\cvcert}[3]{
  \begin{tabularx}{\linewidth}{l}
  {\faChevronRight \emph #2}\\
  {\small \color{emphasis} #3}, #1
  \end{tabularx}
  \smallskip
  }

\renewcommand{\cvevent}[5]{
  \ifstrequal{#4}{#5}{  
    ...
    {\small\makebox[0.5\linewidth][l]%
      ...
      \begin{minipage}{.29\columnwidth}
        \ifstrempty{#5}{}{\includegraphics[width=.9\columnwidth]{#5}}
        {\small\makebox[0.5\linewidth][l]%
          {\BeginAccSupp{method=pdfstringdef,ActualText={\locationname:}}\cvLocationMarker\EndAccSupp{}%
            ~#4}%
        }
